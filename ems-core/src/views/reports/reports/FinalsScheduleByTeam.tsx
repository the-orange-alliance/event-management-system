...
class FinalsScheduleByTeam extends React.Component<IProps, IState> {
    ...
    this._teamMatches.forEach((teamMatches: Match[], teamNumber: number) => {
      ...
      reports.push(
        <ReportTemplate
          ...
          children={view}
          generated={generated}
          name={"Finals Schedule For " + displayName}
...
export default connect(mapStateToProps)(FinalsScheduleByTeam);