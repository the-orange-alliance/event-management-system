...
class QualificationSchedule extends React.Component<IProps, IState> {
  ...
  public render() {
    const {onHTMLUpdate, eventConfig, qualificationMatches, fields} = this.props;
...
export default connect(mapStateToProps)(QualificationSchedule);