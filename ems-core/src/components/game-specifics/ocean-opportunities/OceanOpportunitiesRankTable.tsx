...
import {TeamIdentifier, OceanOpportunitiesRank} from "@the-orange-alliance/lib-ems";

interface IProps {
  rankings: OceanOpportunitiesRank[],
  identifier?: TeamIdentifier
}

class OceanOpportunitiesRankTable extends React.Component<IProps> {
      ...
      <Table color={getTheme().secondary} attached={true} celled={true} textAlign="center" columns={16}>
        <Table.Header>
          <Table.Row>
            ...
            <Table.HeaderCell>Coopertition Bonuses</Table.HeaderCell>
...
export default OceanOpportunitiesRankTable;