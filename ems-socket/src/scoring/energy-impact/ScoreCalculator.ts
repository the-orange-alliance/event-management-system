...
export default class ScoreCalculator {
  ...
  public static getBlueSum() {
    ...
    let time_dependent_score = EIScoreTable.getSolarPts(solar_time) + EIScoreTable.getWindPts(ScoreManager.getDetails(BLUE).windTurbinePoints) + EIScoreTable.getReactorPts(ScoreManager.getDetails(BLUE).windTurbinePoints);
